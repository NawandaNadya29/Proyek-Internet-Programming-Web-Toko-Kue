...
<body>
    ...
    <main>
        <div id="content">
            <div class="card" data-aos="zoom-in" data-aos-offset="200" data-aos-duration="1000" data-aos-once="true">
                <h3 class="judul">Siapa Kami?</h3>
                <p style="text-indent: 1.2rem;">Kue Nana adalah toko kue yang berdiri sejak tahun 2021, kami terus berupaya menyediakan aneka ragam produk kue yang sehat untuk dikonsumsi masyarakat dan memberikan pelayanan yang terbaik kepada konsumen.</p>
            </div>
        </div>
    </main>
